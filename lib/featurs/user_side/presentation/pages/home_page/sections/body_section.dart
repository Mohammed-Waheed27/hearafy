              ...
              child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        //later here will take the index of the pressd container and use that data to display the acual workers
                        ///for now im just gonna navgate tot he page and use a dummy data to display only to view the ui
